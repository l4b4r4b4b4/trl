...
class EvolMergeTrainer(LaserRMTrainer):
    r"""
    Initialize EvolMergeTrainer.

    Args:
        model (`transformers.PreTrainedModel`):
            The model to train, preferably an `AutoModelForSequenceClassification`.
        args (`EvolMergeConfig`):
    ...
    def __init__(
        ...
        args: Optional[EvolMergeConfig] = None,
        ...
        if args.model_init_kwargs is None:
            ...
            raise ValueError("You passed model_kwargs to the EvolMergeTrainer. But your model is already instantiated.")
        else:
        ...
        if isinstance(model, str):
            warnings.warn(
                "You passed a model_id to the EvolMergeTrainer. This will automatically create an "
        ...
        if args.max_length is None:
            warnings.warn(
                "`max_length` is not set in the EvolMergeConfig's init"
        ...
        if args.max_prompt_length is None:
            warnings.warn(
                "`max_prompt_length` is not set in the EvolMergeConfig's init"
        ...
        if args.max_completion_length is None and self.is_encoder_decoder:
            warnings.warn(
                "When using an encoder decoder architecture, you should set `max_completion_length` in the EvolMergeConfig's init"
                " it will default to `128` by default, but you should do it yourself in the future.",
                UserWarning,
            )
